...
(function(){
	...
	*/
	function getSessionId()
	{
		...
		tgNS.sessionId = tgNS.sessionId || window.pr || (Math.floor(Math.random() * 1000000));
		window.pr = tgNS.sessionId;
	...
	*/
	...
	{
		//tgNS.sessionId = 0;
		tgNS.sessionId = (Math.floor(Math.random() * 1000000));
	}
	...
	*/
	function loadBanner(placeholderId, requestSrc, sessionId){
		...
		document.getElementById('AdFox_banner_'+placeholderId).style.cssText = '';
